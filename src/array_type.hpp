...
public:
    ArrayType(TypeVariable* type_variable, DimType dim_type): dimensions(1), type_variable(std::make_shared<TypeVariable>(*type_variable)), Type(TypeTag::Array) {}
    ArrayType(TypeVariable* type_variable, unsigned int dimensions, DimType dim_type): dimensions(dimensions), type_variable(std::make_shared<TypeVariable>(*type_variable)), Type(TypeTag::Array) {}
